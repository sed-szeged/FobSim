...
class User:
    ...
    def create_tasks(self, num_of_task_per_user, blockchain_function, list_of_end_users):
        if blockchain_function == 1:
            ...
            print(str(num_of_task_per_user) + " data records had been generated by End-User no. " + str(self.addressParent)
                  + "." + str(self.addressSelf))
...
def add_new_attributes(user):
    print(user.identity_added_attributes)
